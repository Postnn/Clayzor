...
/// </summary>
public static class KescoFilterUrlHelper
{
    ...
    /// </summary>
    public static string? Serialize(KescoFilterGroupNode? root)
    {
    ...
    /// </summary>
    public static KescoFilterGroupNode? Deserialize(string? base64Url)
    {
