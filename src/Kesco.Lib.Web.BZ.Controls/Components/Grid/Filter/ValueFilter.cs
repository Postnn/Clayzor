...
/// </summary>
/// <remarks>
/// Реализует <see cref="IKescoFilterNode"/> наравне с <see cref="ColumnFilter"/>
/// и <see cref="KescoFilterGroupNode"/>. В одной колонке одновременно активен либо
...
/// (<see cref="KescoCompositeSqlBuilder"/>).
/// </remarks>
public sealed class ValueFilter : IKescoFilterNode
{
    ...
    /// Семантику в SQL разворачивает <see cref="KescoCompositeSqlBuilder"/> (V2).
    /// </summary>
    ...
    /// </summary>
    public IKescoFilterNode Clone() => new ValueFilter
    {
        Column       = Column,
        Values       = [..Values],
        Negate       = Negate,
