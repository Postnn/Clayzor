...
## Статус
- **V1–V7, V9, V10, V12, V13, V14 — СДЕЛАНО, закоммичено.**
- **V8 — (позже) опциональный.**
- **V11 — KescoCheckbox компонент — не реализовано.**
...
| V8 | Панель/чипы/описание для печати; тумблер в настройках | опц. | — |
