...
public class GridGroupAgg
{
    ...
    /// <summary>Количество строк детализации. Для синтетических родителей вычисляется через <see cref="KescoGroupingEngine.ComputeParentCounts"/>.</summary>
...
public class GridGroupNode
{
    ...
    /// Вычисляется в <see cref="KescoGroupingEngine.ComputeEffectiveRows"/>.
    /// </summary>
...
/// Формируется при обходе дерева в <see cref="KescoGroupingEngine.WalkTree"/>.
/// </summary>
...
/// <summary>
/// Статический движок серверной группировки для <see cref="KescoGrid{TEntity}"/>.
...
/// </summary>
public static class KescoGroupingEngine
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="fullOrderBy">Полный ORDER BY из <see cref="KescoDataQuery.BuildOrderBy"/>.</param>
