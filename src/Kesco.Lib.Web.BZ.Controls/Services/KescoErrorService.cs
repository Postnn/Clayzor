...
/// Реализует <see cref="ISqlErrorHandler"/> — <see cref="Kesco.Lib.DALC.DbManager"/> вызывает
/// <see cref="HandleSqlError"/> автоматически при любом <see cref="SqlException"/>.
/// Компонент <see cref="Components.KescoErrorBar"/> отображает баннер с детализацией.
/// </summary>
public class KescoErrorService : ISqlErrorHandler
{
    ...
    /// <summary>Событие изменения состояния — <see cref="Components.KescoErrorBar"/> подписывается для перерисовки.</summary>
