// ── Kesco Grid — Column Header Insert Drag ────────────────────────────────────
//
...
//   - SetDraggedColumn(sql) устанавливает KescoDragState для tray-drop.

window.kescoGridColumnDrag = (function () {
    ...
    function init(gridId, dotnetRef) {
        ...
        function getOrCreateIndicator() {
            if (!indicator) {
                ...
                indicator.className = 'kesco-grid-drop-indicator';
