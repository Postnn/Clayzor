...
| **KescoColumnSettingsDialog** — диалог настройки порядка и видимости колонок (jQuery UI Sortable drag-and-drop) | [docs/kesco-grid.md](docs/kesco-grid.md) |
