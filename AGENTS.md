...
| **DistinctValuesResult** — результат `LoadDistinctValuesAsync`: `Values` (IReadOnlyList<object?>), `Capped` (> лимита 100), `HasBlanks` (есть NULL/пустые), `TotalDistinct` (полное число) | [docs/kesco-grid.md](docs/kesco-grid.md) |
